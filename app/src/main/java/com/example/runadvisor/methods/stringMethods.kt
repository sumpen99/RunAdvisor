...
fun fragmentInstanceToFragment(fragmentInstance:FragmentInstance): Fragment{
    when(fragmentInstance){
        FragmentInstance.FRAGMENT_MAP->{return MapFragment(false,MenuType.MENU_TRACK,FragmentInstance.FRAGMENT_MAP)}
        FragmentInstance.FRAGMENT_MAP_CHILD->{return MapFragment(true,MenuType.MENU_TRACK,FragmentInstance.FRAGMENT_MAP_CHILD)}
